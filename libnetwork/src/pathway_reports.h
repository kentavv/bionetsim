...
void buildMoleculeEquations(const QList<PathwayCanvasItem> &items, QString &text, int ws);

void buildMoleculeReducedEquationsCVODE(const QList<PathwayCanvasItem> &items, QString &text, int ws);
void buildMoleculeReducedEquationsMathematica(const QList<PathwayCanvasItem> &items, QString &text, int ws);
